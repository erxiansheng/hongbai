...
本项目深度集成阿里云 ESA（边缘安全加速）服务，充分利用边缘计算能力实现高性能、低成本的游戏分发方案。
...
- 🎮 **多平台支持**：FC/NES、街机、GBA 等
- 👥 **联机对战**：最多4人同时游玩（WebRTC P2P）
- 🎤 **语音聊天**：实时语音交流（WebRTC P2P）
- 📱 **手机适配**：虚拟手柄操控，横屏全屏优化
- 💾 **存档功能**：即时存档/读档
- 📦 **智能缓存**：四级缓存架构，极速加载
- ⌨️ **自定义按键**：键盘/手柄映射
